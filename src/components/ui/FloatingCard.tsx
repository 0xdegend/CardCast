...
export function FloatingCard({
  ...
  return (
    ...
    >
      ...
      <div
        ref={glowRef}
        className="absolute inset-[-20px] rounded-2xl blur-2xl opacity-50 pointer-events-none transition-none"
        style={{ background: glowColor, zIndex: 0 }}
      />
        ...
        <div className="relative z-10 p-3 flex flex-col items-center gap-1.5">
          ...
          >
            ...
            <div
              ...
              style={{
                background: `radial-gradient(circle at 60% 30%, white, transparent 60%)`,
              }}
            />
          </div>
